            ...
            <table class="table  table-hover table-striped">
                ...
                <?php foreach ($categoryNames as $index => $categoryName): ?>
                    <tr>
                        ...
                        <td><?php echo number_format($hasilperkategori[$index + 5], 1); ?></td>
                         <td><?php
